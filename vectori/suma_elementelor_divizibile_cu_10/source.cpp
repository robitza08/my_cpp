...
int main() {
    ...
    int suma_numere_divizibile_cu_10=0;
    for(int i=0; i < v.size(); i++) { 
        if (v[i]%10==0) { 
            suma_numere_divizibile_cu_10 = suma_numere_divizibile_cu_10 + v[i];    
        } 
    } 
    cout << "Suma numerelor divizibile cu 10 din vector este: " << suma_numere_divizibile_cu_10;
